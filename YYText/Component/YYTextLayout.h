...
@property (nullable, strong) UIBezierPath *path;

/// An array of `UIBezierPath` for path exclusion. Default is nil.
@property (nullable, strong) NSArray<UIBezierPath *> *exclusionPaths;
...
@property (nullable, strong) NSAttributedString *truncationToken;
...
@property (nullable, strong) id<YYTextLinePositionModifier> linePositionModifier;
@end
