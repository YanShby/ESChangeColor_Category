...
@property (nullable, nonatomic, strong) NSString *string; ///< backed string
@end
 ...
 */
@property (nullable, nonatomic, strong) YYTextAction tapAction;

/**
 Long press action when user long press the highlight, default is nil.
 If the value is nil, YYTextView or YYLabel will ask it's delegate to handle the long press action.
 */
@property (nullable, nonatomic, strong) YYTextAction longPressAction;
