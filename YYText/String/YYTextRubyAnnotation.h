...
@property (nullable, nonatomic, strong) NSString *textBefore;

/// The ruby text is positioned after the base text;
/// i.e. below horizontal text and to the left of vertical text.
@property (nullable, nonatomic, strong) NSString *textAfter;
...
@property (nullable, nonatomic, strong) NSString *textInterCharacter;

/// The ruby text follows the base text with no special styling.
@property (nullable, nonatomic, strong) NSString *textInline;
