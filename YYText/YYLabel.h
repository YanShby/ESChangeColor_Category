 ...
 */
@property (nullable, nonatomic, strong) NSAttributedString *truncationToken;
 ...
 */
@property (nullable, nonatomic, strong) UIBezierPath *textContainerPath;
 ...
 */
@property (nullable, nonatomic, strong) id<YYTextLinePositionModifier> linePositionModifier;

/**
 The debug option to display CoreText layout result.
 The default value is [YYTextDebugOption sharedDebugOption].
 */
@property (nullable, nonatomic, strong) YYTextDebugOption *debugOption;
...
/**
 ...
 The default value is nil.
 */
@property (nullable, nonatomic, strong) YYTextAction textTapAction;

/**
 When user long press the label, this action will be called (similar to long press gesture).
 The default value is nil.
 */
@property (nullable, nonatomic, strong) YYTextAction textLongPressAction;

/**
 When user tap the highlight range of text, this action will be called.
 The default value is nil.
 */
@property (nullable, nonatomic, strong) YYTextAction highlightTapAction;

/**
 When user long press the highlight range of text, this action will be called.
 The default value is nil. 
 */
@property (nullable, nonatomic, strong) YYTextAction highlightLongPressAction;
...
IB_DESIGNABLE
@interface YYLabel : UIView <NSCoding>
@property (nullable, nonatomic, strong) IBInspectable NSString *text;
...
@property (nullable, nonatomic, strong) IBInspectable NSAttributedString *attributedText;
...
@property (nonatomic) UIEdgeInsets textContainerInset;
@property (nullable, nonatomic, strong) id<YYTextLinePositionModifier> linePositionModifier;
@property (nonnull, nonatomic, strong) YYTextDebugOption *debugOption;
@property (nullable, nonatomic, strong) YYTextAction textTapAction;
@property (nullable, nonatomic, strong) YYTextAction textLongPressAction;
@property (nullable, nonatomic, strong) YYTextAction highlightTapAction;
@property (nullable, nonatomic, strong) YYTextAction highlightLongPressAction;
