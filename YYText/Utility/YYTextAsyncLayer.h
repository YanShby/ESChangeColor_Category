 ...
 */
@property (nullable, nonatomic, strong) void (^willDisplay)(CALayer *layer);
 ...
 */
@property (nullable, nonatomic, strong) void (^display)(CGContextRef context, CGSize size, BOOL(^isCancelled)(void));
 ...
 */
@property (nullable, nonatomic, strong) void (^didDisplay)(CALayer *layer, BOOL finished);
